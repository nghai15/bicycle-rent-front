    ...
    <footer id="main-footer">
        <div class="footer-container">
            <div class="footer-col company-info">
                <img src="../img/face.jpg" alt="Logo" id="logo">
                <p>Hệ thống dịch vụ thuê xe đạp tự động .<br></p>
                <ul class="footer-contact">
                    ...
                    <li><i class="fa-solid fa-envelope"></i> Email: ABCD@ut.edu.vn</li>
                </ul>
            </div>
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="#">Dịch vụ cốt lõi</a></li>
